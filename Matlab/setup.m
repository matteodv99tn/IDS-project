...
config.feature_extraction.epsilon = 0.015;
...
config.camera.d_std             = 0.001;                % distance estimation standard deviation
config.camera.theta_std         = 0.03 * pi / 180;      % angle estimation std;
